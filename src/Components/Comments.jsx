  ...
  return (
    <div style={{ marginBottom: "1rem", marginRight: "3rem", width: "100%" }}>
      ...
      <div
        ...
        className={`${
          windowSize > 1037 ? "comment-input" : "comment-input-full"
        } w-full pr-5`}
      >
        <section className="profile-section">
          {user ? (
            <img className="user-profile-picture" src={user.avatar_url} />
          ) : (
            <svg
              className="circle w-[45px] h-[45px] top-0 relative left-[50%]"
              version="1.0"
            ...
            >
              ...
              <g transform="translate(0.000000,300.000000) scale(0.100000,-0.100000)">
                {" "}
                <path d="M1325 2985 c-203 -44 -400 -199 -495 -390 -95 -192 -95 -447 1 -636 98 -196 272 -335 481 -384 92 -22 258 -19 352 5 187 47 354 180 454 360 107 192 109 446 5 660 -39 81 -59 108 -137 185 -72 72 -109 99 -176 133 -47 24 -110 50 -140 58 -83 22 -261 27 -345 9z m300 -180 c166 -44 324 -196 375 -364 24 -75 28 -215 10 -296 -32 -144 -153 -292 -292 -359 -214 -103 -454 -61 -624 108 -221 220 -216 562 10 779 105 101 219 146 366 147 55 0 121 -7 155 -15z" />{" "}
                <path d="M752 1530 c-103 -27 -167 -64 -242 -140 -162 -164 -245 -415 -257 -770 -6 -202 2 -256 53 -359 61 -122 187 -216 333 -247 100 -21 1615 -20 1716 1 205 43 351 194 386 398 8 48 9 117 5 205 -19 386 -125 671 -304 815 -93 75 -278 131 -373 113 -20 -3 -83 -36 -140 -73 -158 -101 -307 -153 -436 -153 -113 1 -248 45 -374 122 -168 102 -180 108 -239 107 -30 0 -88 -9 -128 -19z m247 -222 c185 -120 332 -163 531 -155 181 6 306 49 487 168 75 49 80 51 135 46 255 -22 413 -325 413 -793 0 -170 0 -171 -30 -229 -21 -40 -46 -71 -79 -96 -96 -72 -56 -70 -976 -67 l-825 3 -50 23 c-142 65 -193 179 -181 401 24 421 141 672 347 745 86 30 122 23 228 -46z" />{" "}
              </g>{" "}
            </svg>
          )}
        </section>
        <section
          style={{ width: "200px" }}
          className={`${
            windowSize > 1037 ? "make-comment" : "make-comment-full"
          } relative w-full`}
        >
          <input
            className={
              isDark
                ? "post-comment-night bg-base-100 "
                : "post-comment bg-base-100"
            }
          ...
          {commentFocus && (
            <div className="post-comment-buttons">
              <button className="comment-buttons btn btn-ghost btn-sm h-10">
                Cancel
              </button>
      ...
      {comments.map((comment, index) => {
        return (
          <div
            className={`${windowSize > 1037 ? "comment" : "comment-full"} pr-5`}
          >
            <section className="profile-section">
              <img
                  ...
                  >
                    {upvote[comment.comment_id] ? (
                      ...
                      >
                        ...
                        >
                          {" "}
                          <path d="M2823 5856 c-585 -714 -2027 -2536 -2036 -2571 -7 -26 2 -66 21 -95 l33 -50 619 0 620 0 0 -1451 c0 -1570 -3 -1526 109 -1629 l54 -50 757 0 757 0 54 50 c112 103 109 59 109 1629 l0 1451 620 0 619 0 33 50 c54 83 46 94 -1056 1470 -1239 1545 -1118 1435 -1313 1196z m-839 -2451 c-147 -3 -381 -3 -520 0 -140 3 -20 6 266 6 286 0 400 -3 254 -6z m2501 0 c-135 -3 -355 -3 -490 0 -135 4 -24 6 245 6 270 0 380 -2 245 -6z" />{" "}
                        </g>{" "}
                      </svg>
                    ) : (
                      <svg
                  ...
                  >
                    {downVote[comment.comment_id] ? (
                      ...
                      >
                        ...
                        <g transform="translate(0.000000,300.000000) scale(0.100000,-0.100000)">
                          {" "}
                          <path d="M1125 2991 c-27 -12 -62 -50 -74 -84 -8 -19 -11 -264 -11 -753 l0 -724 -310 0 -310 0 -16 -25 c-9 -14 -14 -34 -10 -47 3 -13 245 -322 538 -688 522 -652 534 -665 568 -665 34 0 46 13 568 665 293 366 535 675 538 688 4 13 -1 33 -10 47 l-16 25 -310 0 -310 0 0 725 c0 786 1 763 -55 815 l-27 25 -366 2 c-202 1 -376 -2 -387 -6z m705 -885 c0 -682 2 -766 16 -780 8 -9 16 -17 17 -18 1 -1 123 -5 270 -8 l269 -5 -449 -562 c-246 -309 -450 -562 -453 -562 -3 0 -207 253 -453 562 l-449 562 269 5 c147 3 269 7 270 8 1 1 9 9 17 18 14 14 16 98 16 780 l0 764 330 0 330 0 0 -764z" />{" "}
                        </g>{" "}
                      </svg>
                    )}
                  </button>
